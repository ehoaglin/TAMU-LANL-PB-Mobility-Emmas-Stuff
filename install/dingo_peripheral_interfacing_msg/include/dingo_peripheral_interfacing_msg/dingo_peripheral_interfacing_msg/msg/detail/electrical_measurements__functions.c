...
dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__create(void)
{
  ...
  dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements * msg = (dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements *)allocator.allocate(sizeof(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements));
  bool success = dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__init(msg);
  if (!success) {
...
dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__destroy(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence__init(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements * data = NULL;

  if (size) {
    data = (dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements *)allocator.zero_allocate(size, sizeof(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__fini(&data[i - 1]);
      }
...
dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence__fini(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence * array = (dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence *)allocator.allocate(sizeof(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence__init(array, size);
  if (!success) {
...
dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence__destroy(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence__are_equal(const dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence * lhs, const dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements * data =
      (dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dingo_peripheral_interfacing_msg__msg__ElectricalMeasurements__copy(
