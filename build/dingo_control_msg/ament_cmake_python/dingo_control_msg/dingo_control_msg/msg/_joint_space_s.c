...
bool dingo_control_msg__msg__joint_space__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dingo_control_msg.msg._joint_space.JointSpace", full_classname_dest, 45) == 0);
  }
  dingo_control_msg__msg__JointSpace * ros_message = _ros_message;
  {  // header
  ...
  {  // fl_foot
    ...
    if (!dingo_control_msg__msg__angle__convert_from_py(field, &ros_message->fl_foot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // fr_foot
    ...
    if (!dingo_control_msg__msg__angle__convert_from_py(field, &ros_message->fr_foot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // rl_foot
    ...
    if (!dingo_control_msg__msg__angle__convert_from_py(field, &ros_message->rl_foot)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * dingo_control_msg__msg__joint_space__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dingo_control_msg.msg._joint_space");
  ...
  {  // fl_foot
    PyObject * field = NULL;
    field = dingo_control_msg__msg__angle__convert_to_py(&ros_message->fl_foot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // fr_foot
    PyObject * field = NULL;
    field = dingo_control_msg__msg__angle__convert_to_py(&ros_message->fr_foot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // rl_foot
    PyObject * field = NULL;
    field = dingo_control_msg__msg__angle__convert_to_py(&ros_message->rl_foot);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // rr_foot
    PyObject * field = NULL;
    field = dingo_control_msg__msg__angle__convert_to_py(&ros_message->rr_foot);
    if (!field) {
      return NULL;
    }
    {
