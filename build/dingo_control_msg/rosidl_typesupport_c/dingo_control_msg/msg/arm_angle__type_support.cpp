...
static const _ArmAngle_type_support_symbol_names_t _ArmAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dingo_control_msg, msg, ArmAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dingo_control_msg, msg, ArmAngle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dingo_control_msg, msg, ArmAngle)() {
  return &::dingo_control_msg::msg::rosidl_typesupport_c::ArmAngle_message_type_support_handle;
}
