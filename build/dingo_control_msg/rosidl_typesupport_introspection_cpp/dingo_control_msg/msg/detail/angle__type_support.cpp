...
{
  new (message_memory) dingo_control_msg::msg::Angle(_init);
}

void Angle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dingo_control_msg::msg::Angle *>(message_memory);
  typed_message->~Angle();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Angle_message_member_array[3] = {
  {
    ...
    offsetof(dingo_control_msg::msg::Angle, theta1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::Angle, theta2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::Angle, theta3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Angle_message_members = {
  ...
  "Angle",  // message name
  3,  // number of fields
  sizeof(dingo_control_msg::msg::Angle),
...
get_message_type_support_handle<dingo_control_msg::msg::Angle>()
{
  return &::dingo_control_msg::msg::rosidl_typesupport_introspection_cpp::Angle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control_msg, msg, Angle)() {
  return &::dingo_control_msg::msg::rosidl_typesupport_introspection_cpp::Angle_message_type_support_handle;
}
