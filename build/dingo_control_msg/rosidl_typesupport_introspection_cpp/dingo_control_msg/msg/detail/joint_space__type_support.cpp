...
{
  new (message_memory) dingo_control_msg::msg::JointSpace(_init);
}

void JointSpace_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dingo_control_msg::msg::JointSpace *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointSpace_message_member_array[6] = {
  {
    ...
    offsetof(dingo_control_msg::msg::JointSpace, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dingo_control_msg::msg::Angle>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::JointSpace, fl_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::JointSpace, fr_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::JointSpace, rl_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::JointSpace, rr_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<dingo_control_msg::msg::JointSpace>()
{
  return &::dingo_control_msg::msg::rosidl_typesupport_introspection_cpp::JointSpace_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control_msg, msg, JointSpace)() {
  return &::dingo_control_msg::msg::rosidl_typesupport_introspection_cpp::JointSpace_message_type_support_handle;
}
