...
{
  new (message_memory) dingo_control_msg::msg::ArmAngle(_init);
}

void ArmAngle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dingo_control_msg::msg::ArmAngle *>(message_memory);
  typed_message->~ArmAngle();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmAngle_message_member_array[4] = {
  {
    "theta1",  // name
    ...
    offsetof(dingo_control_msg::msg::ArmAngle, theta1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::ArmAngle, theta2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::ArmAngle, theta3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control_msg::msg::ArmAngle, theta4),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArmAngle_message_members = {
  ...
  4,  // number of fields
  sizeof(dingo_control_msg::msg::ArmAngle),
...
get_message_type_support_handle<dingo_control_msg::msg::ArmAngle>()
{
  return &::dingo_control_msg::msg::rosidl_typesupport_introspection_cpp::ArmAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control_msg, msg, ArmAngle)() {
  return &::dingo_control_msg::msg::rosidl_typesupport_introspection_cpp::ArmAngle_message_type_support_handle;
}
