...
#include "dingo_control_msg/msg/detail/joint_space__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const dingo_control_msg::msg::Angle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  dingo_control_msg::msg::Angle &);
size_t get_serialized_size(
  const dingo_control_msg::msg::Angle &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const dingo_control_msg::msg::JointSpace & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dingo_control_msg::msg::JointSpace & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: fl_foot
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dingo_control_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  size_t current_alignment)
{
  ...
  // Member: fl_foot
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dingo_control_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dingo_control_msg::msg::JointSpace *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dingo_control_msg::msg::JointSpace *>(
    untyped_ros_message);
...
{
  return &dingo_control_msg::msg::typesupport_fastrtps_cpp::_JointSpace__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dingo_control_msg, msg, JointSpace)() {
  return &dingo_control_msg::msg::typesupport_fastrtps_cpp::_JointSpace__handle;
}
