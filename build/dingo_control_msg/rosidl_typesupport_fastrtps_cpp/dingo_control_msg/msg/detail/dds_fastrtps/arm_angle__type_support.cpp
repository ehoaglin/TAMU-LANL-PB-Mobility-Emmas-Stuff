...
#include "dingo_control_msg/msg/detail/arm_angle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dingo_control_msg::msg::ArmAngle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dingo_control_msg::msg::ArmAngle & ros_message)
{
  // Member: theta1
  cdr >> ros_message.theta1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dingo_control_msg::msg::ArmAngle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dingo_control_msg::msg::ArmAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dingo_control_msg::msg::ArmAngle *>(
    untyped_ros_message);
...
{
  return &dingo_control_msg::msg::typesupport_fastrtps_cpp::_ArmAngle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dingo_control_msg, msg, ArmAngle)() {
  return &dingo_control_msg::msg::typesupport_fastrtps_cpp::_ArmAngle__handle;
}
