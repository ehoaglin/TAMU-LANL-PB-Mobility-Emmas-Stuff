...
bool dingo_control_msg__msg__arm_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dingo_control_msg.msg._arm_angle.ArmAngle", full_classname_dest, 41) == 0);
  }
  dingo_control_msg__msg__ArmAngle * ros_message = _ros_message;
  {  // theta1
  ...
  {  // theta4
    ...
    assert(PyFloat_Check(field));
    ros_message->theta4 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ArmAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dingo_control_msg.msg._arm_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmAngle");
