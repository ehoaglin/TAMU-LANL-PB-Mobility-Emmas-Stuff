...
#ifndef DINGO_CONTROL_MSG__MSG__DETAIL__ANGLE__TRAITS_HPP_
#define DINGO_CONTROL_MSG__MSG__DETAIL__ANGLE__TRAITS_HPP_
...
inline void to_yaml(
  const dingo_control_msg::msg::Angle & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dingo_control_msg::msg::Angle & msg)
{
  return dingo_control_msg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dingo_control_msg::msg::Angle>()
{
  return "dingo_control_msg::msg::Angle";
}

template<>
inline const char * name<dingo_control_msg::msg::Angle>()
{
  return "dingo_control_msg/msg/Angle";
}

template<>
struct has_fixed_size<dingo_control_msg::msg::Angle>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<dingo_control_msg::msg::Angle>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<dingo_control_msg::msg::Angle>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DINGO_CONTROL_MSG__MSG__DETAIL__ANGLE__TRAITS_HPP_
