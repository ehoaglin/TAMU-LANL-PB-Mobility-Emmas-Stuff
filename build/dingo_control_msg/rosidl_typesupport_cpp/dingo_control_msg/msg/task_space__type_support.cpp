...
static const _TaskSpace_type_support_symbol_names_t _TaskSpace_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dingo_control_msg, msg, TaskSpace)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control_msg, msg, TaskSpace)),
  }
};
...
{
  return &::dingo_control_msg::msg::rosidl_typesupport_cpp::TaskSpace_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dingo_control_msg, msg, TaskSpace)() {
  return get_message_type_support_handle<dingo_control_msg::msg::TaskSpace>();
}
