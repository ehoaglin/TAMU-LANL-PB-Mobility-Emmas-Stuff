...
static const _ArmAngle_type_support_symbol_names_t _ArmAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dingo_control_msg, msg, ArmAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control_msg, msg, ArmAngle)),
  }
};
...
{
  return &::dingo_control_msg::msg::rosidl_typesupport_cpp::ArmAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dingo_control_msg, msg, ArmAngle)() {
  return get_message_type_support_handle<dingo_control_msg::msg::ArmAngle>();
}
