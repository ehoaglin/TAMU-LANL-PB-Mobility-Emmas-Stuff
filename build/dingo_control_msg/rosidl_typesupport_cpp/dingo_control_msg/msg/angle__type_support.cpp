...
static const _Angle_type_support_symbol_names_t _Angle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dingo_control_msg, msg, Angle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control_msg, msg, Angle)),
  }
};
...
{
  return &::dingo_control_msg::msg::rosidl_typesupport_cpp::Angle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dingo_control_msg, msg, Angle)() {
  return get_message_type_support_handle<dingo_control_msg::msg::Angle>();
}
