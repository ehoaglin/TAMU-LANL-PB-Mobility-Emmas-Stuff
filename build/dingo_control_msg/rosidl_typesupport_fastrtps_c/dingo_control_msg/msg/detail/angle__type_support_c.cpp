...
#include "dingo_control_msg/msg/detail/angle__rosidl_typesupport_fastrtps_c.h"
...
using _Angle__ros_msg_type = dingo_control_msg__msg__Angle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dingo_control_msg__msg__Angle;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dingo_control_msg__msg__Angle * ros_message = static_cast<const dingo_control_msg__msg__Angle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dingo_control_msg__msg__Angle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dingo_control_msg__msg__Angle * ros_message = static_cast<dingo_control_msg__msg__Angle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dingo_control_msg__msg__Angle(cdr, ros_message);
}

static uint32_t _Angle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dingo_control_msg__msg__Angle(
...
static size_t _Angle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dingo_control_msg__msg__Angle(
