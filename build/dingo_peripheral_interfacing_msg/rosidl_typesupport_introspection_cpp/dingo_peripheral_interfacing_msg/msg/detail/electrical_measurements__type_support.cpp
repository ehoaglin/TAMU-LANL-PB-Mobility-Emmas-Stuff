...
{
  new (message_memory) dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements(_init);
}

void ElectricalMeasurements_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ElectricalMeasurements_message_member_array[2] = {
  {
    ...
    offsetof(dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements, battery_voltage_level),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements, servo_buck_voltage_level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ElectricalMeasurements_message_members = {
  "dingo_peripheral_interfacing_msg::msg",  // message namespace
  "ElectricalMeasurements",  // message name
  2,  // number of fields
  sizeof(dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements),
...
{
  return &::dingo_peripheral_interfacing_msg::msg::rosidl_typesupport_introspection_cpp::ElectricalMeasurements_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_peripheral_interfacing_msg, msg, ElectricalMeasurements)() {
  return &::dingo_peripheral_interfacing_msg::msg::rosidl_typesupport_introspection_cpp::ElectricalMeasurements_message_type_support_handle;
}
