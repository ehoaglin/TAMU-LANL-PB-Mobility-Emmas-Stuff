...
#include "dingo_peripheral_interfacing_msg/msg/detail/electrical_measurements__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dingo_peripheral_interfacing_msg
cdr_serialize(
  const dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements & ros_message)
{
  // Member: battery_voltage_level
  cdr >> ros_message.battery_voltage_level;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dingo_peripheral_interfacing_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<dingo_peripheral_interfacing_msg::msg::ElectricalMeasurements>()
{
  return &dingo_peripheral_interfacing_msg::msg::typesupport_fastrtps_cpp::_ElectricalMeasurements__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dingo_peripheral_interfacing_msg, msg, ElectricalMeasurements)() {
  return &dingo_peripheral_interfacing_msg::msg::typesupport_fastrtps_cpp::_ElectricalMeasurements__handle;
}
