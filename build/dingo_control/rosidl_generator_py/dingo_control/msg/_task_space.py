...
class TaskSpace(metaclass=Metaclass_TaskSpace):
    ...
    _fields_and_field_types = {
        ...
        'fl_foot': 'geometry_msgs/Point',
        'fr_foot': 'geometry_msgs/Point',
        'rl_foot': 'geometry_msgs/Point',
        'rr_foot': 'geometry_msgs/Point',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Point
        self.fl_foot = kwargs.get('fl_foot', Point())
        from geometry_msgs.msg import Point
        self.fr_foot = kwargs.get('fr_foot', Point())
        from geometry_msgs.msg import Point
        self.rl_foot = kwargs.get('rl_foot', Point())
        from geometry_msgs.msg import Point
        self.rr_foot = kwargs.get('rr_foot', Point())
    ...
    def fl_foot(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'fl_foot' field must be a sub message of type 'Point'"
        self._fl_foot = value
    ...
    def fr_foot(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, Point), \
                "The 'fr_foot' field must be a sub message of type 'Point'"
        self._fr_foot = value
    ...
    def rl_foot(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, Point), \
                "The 'rl_foot' field must be a sub message of type 'Point'"
        self._rl_foot = value
    ...
    def rr_foot(self, value):
        if self._check_fields:
            ...
            assert \
                isinstance(value, Point), \
                "The 'rr_foot' field must be a sub message of type 'Point'"
        self._rr_foot = value
