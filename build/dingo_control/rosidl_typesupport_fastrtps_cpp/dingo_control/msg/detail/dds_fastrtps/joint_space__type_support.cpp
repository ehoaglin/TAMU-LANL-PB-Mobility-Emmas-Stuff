...
#include "dingo_control/msg/detail/joint_space__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const dingo_control::msg::Angle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  dingo_control::msg::Angle &);
size_t get_serialized_size(
  const dingo_control::msg::Angle &,
  size_t current_alignment);
size_t
...
// functions for dingo_control::msg::Angle already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: fl_foot
  dingo_control::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.fl_foot,
    cdr);
  ...
  dingo_control::msg::JointSpace & ros_message)
{
  ...
  // Member: fl_foot
  dingo_control::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: fl_foot
  current_alignment +=
    dingo_control::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: fl_foot
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dingo_control::msg::typesupport_fastrtps_cpp::max_serialized_size_Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = dingo_control::msg::JointSpace;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: fl_foot
  dingo_control::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.fl_foot,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: fl_foot
  current_alignment +=
    dingo_control::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.fl_foot, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: fl_foot
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dingo_control::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dingo_control::msg::JointSpace *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dingo_control::msg::JointSpace *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dingo_control
const rosidl_message_type_support_t *
get_message_type_support_handle<dingo_control::msg::JointSpace>()
{
  return &dingo_control::msg::typesupport_fastrtps_cpp::_JointSpace__handle;
}
