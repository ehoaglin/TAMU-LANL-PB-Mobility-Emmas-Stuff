...
{
  new (message_memory) dingo_control::msg::JointSpace(_init);
}

void JointSpace_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dingo_control::msg::JointSpace *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointSpace_message_member_array[5] = {
  {
    ...
    offsetof(dingo_control::msg::JointSpace, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dingo_control::msg::Angle>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::JointSpace, fl_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::JointSpace, fr_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::JointSpace, rl_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::JointSpace, rr_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointSpace_message_members = {
  ...
  5,  // number of fields
  sizeof(dingo_control::msg::JointSpace),
...
{
  return &::dingo_control::msg::rosidl_typesupport_introspection_cpp::JointSpace_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control, msg, JointSpace)() {
  return &::dingo_control::msg::rosidl_typesupport_introspection_cpp::JointSpace_message_type_support_handle;
}
