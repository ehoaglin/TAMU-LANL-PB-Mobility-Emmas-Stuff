...
def leg_explicit_inverse_kinematics(r_body_foot, leg_index, config):
    ...
    #     self.get_logger.warn('target coordinate: [%f %f %f] too far away', x, y, z)  #originally rospy.logwarn => changed to rclpy node.get_logger().debug('target coordinate: [%f %f %f] too far away', x, y, z)
