...
static const _ElectricalMeasurements_type_support_symbol_names_t _ElectricalMeasurements_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dingo_peripheral_interfacing, msg, ElectricalMeasurements)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dingo_peripheral_interfacing, msg, ElectricalMeasurements)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dingo_peripheral_interfacing, msg, ElectricalMeasurements)() {
  return &::dingo_peripheral_interfacing::msg::rosidl_typesupport_c::ElectricalMeasurements_message_type_support_handle;
}
