...
#include "dingo_control/msg/detail/joint_space__rosidl_typesupport_fastrtps_c.h"
...
#include "dingo_control/msg/detail/angle__functions.h"  // fl_foot, fr_foot, rl_foot, rr_foot
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions

bool cdr_serialize_dingo_control__msg__Angle(
  const dingo_control__msg__Angle * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_dingo_control__msg__Angle(
  eprosima::fastcdr::Cdr & cdr,
  dingo_control__msg__Angle * ros_message);

size_t get_serialized_size_dingo_control__msg__Angle(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_dingo_control__msg__Angle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_dingo_control__msg__Angle(
  const dingo_control__msg__Angle * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_dingo_control__msg__Angle(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_dingo_control__msg__Angle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dingo_control, msg, Angle)();

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_dingo_control
...
using _JointSpace__ros_msg_type = dingo_control__msg__JointSpace;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fl_foot
  {
    cdr_serialize_dingo_control__msg__Angle(
  ...
  dingo_control__msg__JointSpace * ros_message)
{
  ...
  // Field name: fl_foot
  {
    cdr_deserialize_dingo_control__msg__Angle(cdr, &ros_message->fl_foot);
  }

  // Field name: fr_foot
  {
    cdr_deserialize_dingo_control__msg__Angle(cdr, &ros_message->fr_foot);
  }

  // Field name: rl_foot
  {
    cdr_deserialize_dingo_control__msg__Angle(cdr, &ros_message->rl_foot);
  }

  // Field name: rr_foot
  {
    cdr_deserialize_dingo_control__msg__Angle(cdr, &ros_message->rr_foot);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: fl_foot
  current_alignment += get_serialized_size_dingo_control__msg__Angle(
  ...
  size_t current_alignment)
{
  ...
  // Field name: fl_foot
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_dingo_control__msg__Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = dingo_control__msg__JointSpace;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: fl_foot
  {
    cdr_serialize_key_dingo_control__msg__Angle(
      &ros_message->fl_foot, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: fl_foot
  current_alignment += get_serialized_size_key_dingo_control__msg__Angle(
    &(ros_message->fl_foot), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: fl_foot
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_dingo_control__msg__Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dingo_control__msg__JointSpace * ros_message = static_cast<const dingo_control__msg__JointSpace *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dingo_control__msg__JointSpace(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dingo_control__msg__JointSpace * ros_message = static_cast<dingo_control__msg__JointSpace *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dingo_control__msg__JointSpace(cdr, ros_message);
}

static uint32_t _JointSpace__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dingo_control__msg__JointSpace(
...
static size_t _JointSpace__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dingo_control__msg__JointSpace(
