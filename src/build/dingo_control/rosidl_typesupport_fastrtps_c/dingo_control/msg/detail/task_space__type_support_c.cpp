...
#include "dingo_control/msg/detail/task_space__rosidl_typesupport_fastrtps_c.h"
...
using _TaskSpace__ros_msg_type = dingo_control__msg__TaskSpace;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_control
bool cdr_serialize_dingo_control__msg__TaskSpace(
  const dingo_control__msg__TaskSpace * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_control
bool cdr_deserialize_dingo_control__msg__TaskSpace(
  eprosima::fastcdr::Cdr & cdr,
  dingo_control__msg__TaskSpace * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_control
size_t get_serialized_size_dingo_control__msg__TaskSpace(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_control
size_t max_serialized_size_dingo_control__msg__TaskSpace(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dingo_control__msg__TaskSpace;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_control
bool cdr_serialize_key_dingo_control__msg__TaskSpace(
  const dingo_control__msg__TaskSpace * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_control
size_t get_serialized_size_key_dingo_control__msg__TaskSpace(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskSpace__ros_msg_type * ros_message = static_cast<const _TaskSpace__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dingo_control
size_t max_serialized_size_key_dingo_control__msg__TaskSpace(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dingo_control__msg__TaskSpace * ros_message = static_cast<const dingo_control__msg__TaskSpace *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dingo_control__msg__TaskSpace(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dingo_control__msg__TaskSpace * ros_message = static_cast<dingo_control__msg__TaskSpace *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dingo_control__msg__TaskSpace(cdr, ros_message);
}

static uint32_t _TaskSpace__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dingo_control__msg__TaskSpace(
...
static size_t _TaskSpace__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dingo_control__msg__TaskSpace(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dingo_control, msg, TaskSpace)() {
