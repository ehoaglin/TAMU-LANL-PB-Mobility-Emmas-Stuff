...
#ifndef DINGO_CONTROL__MSG__DETAIL__TASK_SPACE__TRAITS_HPP_
#define DINGO_CONTROL__MSG__DETAIL__TASK_SPACE__TRAITS_HPP_
...
inline void to_yaml(
  const dingo_control::msg::TaskSpace & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dingo_control::msg::TaskSpace & msg)
{
  return dingo_control::msg::to_yaml(msg);
}

template<>
inline const char * data_type<dingo_control::msg::TaskSpace>()
{
  return "dingo_control::msg::TaskSpace";
}

template<>
inline const char * name<dingo_control::msg::TaskSpace>()
{
  return "dingo_control/msg/TaskSpace";
}

template<>
struct has_fixed_size<dingo_control::msg::TaskSpace>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Point>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<dingo_control::msg::TaskSpace>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Point>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<dingo_control::msg::TaskSpace>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // DINGO_CONTROL__MSG__DETAIL__TASK_SPACE__TRAITS_HPP_
