...
#include "dingo_control/msg/detail/task_space__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dingo_control::msg::TaskSpace & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dingo_control::msg::TaskSpace & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dingo_control::msg::TaskSpace;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dingo_control::msg::TaskSpace *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dingo_control::msg::TaskSpace *>(
    untyped_ros_message);
...
{
  return &dingo_control::msg::typesupport_fastrtps_cpp::_TaskSpace__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dingo_control, msg, TaskSpace)() {
  return &dingo_control::msg::typesupport_fastrtps_cpp::_TaskSpace__handle;
}
