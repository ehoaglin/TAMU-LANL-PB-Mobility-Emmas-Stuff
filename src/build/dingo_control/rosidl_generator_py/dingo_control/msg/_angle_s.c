...
bool dingo_control__msg__angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dingo_control.msg._angle.Angle", full_classname_dest, 30) == 0);
  }
  dingo_control__msg__Angle * ros_message = _ros_message;
  {  // theta1
...
PyObject * dingo_control__msg__angle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dingo_control.msg._angle");
