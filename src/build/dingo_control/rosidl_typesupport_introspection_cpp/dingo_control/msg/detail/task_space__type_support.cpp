...
{
  new (message_memory) dingo_control::msg::TaskSpace(_init);
}

void TaskSpace_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dingo_control::msg::TaskSpace *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskSpace_message_member_array[5] = {
  {
    ...
    offsetof(dingo_control::msg::TaskSpace, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::TaskSpace, fl_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::TaskSpace, fr_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::TaskSpace, rl_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dingo_control::msg::TaskSpace, rr_foot),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskSpace_message_members = {
  ...
  5,  // number of fields
  sizeof(dingo_control::msg::TaskSpace),
...
{
  return &::dingo_control::msg::rosidl_typesupport_introspection_cpp::TaskSpace_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dingo_control, msg, TaskSpace)() {
  return &::dingo_control::msg::rosidl_typesupport_introspection_cpp::TaskSpace_message_type_support_handle;
}
