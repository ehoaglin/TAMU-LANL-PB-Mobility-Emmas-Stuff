...
from dingo_utilities.src.dingo_utilities.Utilities import deadband, clipped_first_order_filter
...
class InputInterface:
    def __init__(self, config):
        ...
        self.input_messages = self.create_subscription(Joy, "joy", self.input_callback, 10) #changed from rospy.Subscriber("joy", Joy, self.input_callback) to self.input_messages = self.create_subscription( Joy, "joy", self.input_callback,10)
